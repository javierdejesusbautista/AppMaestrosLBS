                ...
                if (c === D.HIDDEN && (E.setState(b, D.LOADED), a.lastChild.style.display = "block"), c === D.UNLOADED)
                    if (E.setState(b, D.LOADING), e) {
                        ...
                        var i = function() {
                                ...
                                c.setAttribute("class", "page-inner"), c.setAttribute("src", y + b + ".html"),c.setAttribute("id", "iframe" + y + b), c.setAttribute("style", "width: " + ((g[b - 1][0])+1) + "px; height: " + g[b - 1][1] + "px; position: relative; border: 0;"), c.onload = function() {
                                    E.setState(b, D.LOADED), m.fire("pageload", {
                                     ...
                                     var touchEmulator =  document.createElement("script")   
                                         touchEmulator.src= "assets/touch-emulator.js"

                                     var touchInit =   document.createElement("script") 
                                         touchInit.text='TouchEmulator()'
									var  iframeAdd =	document.getElementById("iframe"+y +b);
                                         iframeAdd.contentWindow.document.head.appendChild(cssLink);
                                         iframeAdd.contentWindow.document.head.appendChild(touchEmulator);
                                        setTimeout(function() {
                                               iframeAdd.contentWindow.document.head.appendChild(touchInit);
                                            }, 500)
