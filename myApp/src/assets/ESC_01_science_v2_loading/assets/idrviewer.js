/*! IDRViewer - v1.8.0 | Copyright 2018 IDRsolutions */ ! function() {
    "use strict";
    var components,a, b, c, d, e, f, g, h, i, j, k, l, m = {
        ...
        components = [];
    m.setup = function(n) {
        n || (n = IDRViewer.config), x = !0, d = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), f = "svgz" === n.pageType, e = f || "svg" === n.pageType, g = n.bounds, p = n.pagecount, n.url && (y = n.url), E.setup(), b = V("idrviewer");
        ...
        c.setup(o), W.addClass(b, "layout-" + c.toString()), Q(l), c.goToPage(o), E.setPage(o, !0);
        var F = {
        ...
        var compConfig = new XMLHttpRequest;

        compConfig.open("GET", "components/config.json?t=" + DateTime, !0), compConfig.onload = function() {                                             
                if (compConfig.status >= 200 && compConfig.status < 400) {
                    components = JSON.parse(compConfig.responseText);
                } else { console.log("Falta config components") }
        }
        try {
            compConfig.send()
        } catch (d) {}
    ...
    var C = function(a, b) {
            ...
            return c.isVisible = function() {
                ...
                //E.getState(b) === D.LOADED && (E.setState(b, D.HIDDEN), a.firstChild.style.display = "none")
                E.getState(b) === D.LOADED && (E.setState(b, D.HIDDEN), a.lastChild.style.display="none" )
                for(var i = 0; i < a.childElementCount; i++) { 
                    if(a.childNodes[i].class != "page-inner")
                        a.childNodes[i].style.display = "none";
                }
            }, c.unload = function() {
                E.getState(b) !== D.LOADED && E.getState(b) !== D.HIDDEN || (E.setState(b, D.UNLOADED), a.removeChild(a.lastChild))
                m.fire("pageunload", {
                    page: b
                });                                
            }, c.load = function() {
                ...
                if (c === D.HIDDEN && (E.setState(b, D.LOADED), a.lastChild.style.display = "block"), c === D.UNLOADED)
                    if (E.setState(b, D.LOADING), e) {
                        ...
                        var i = function() {
                                ...
                                c.setAttribute("class", "page-inner"), c.setAttribute("src", y + b + ".html"),c.setAttribute("id", "iframe" + y + b), c.setAttribute("style", "width: " + g[b - 1][0] + "px; height: " + g[b - 1][1] + "px; position: relative; border: 0;"), c.onload = function() {
                                    ...
                                    var jsScriptBase = document.createElement("script") 
                                            jsScriptBase.src="components/componentBase.js?t="+DateTime;
                                            document.getElementById("iframe"+y +b).contentWindow.document.head.appendChild(jsScriptBase);
                                    jsScriptBase.onload = function(){
                                        for (var i = 0; i < components.length; i++) {
                                            var jsScript = document.createElement("script") 
                                                jsScript.src="components/"+components[i]+"/"+components[i]+".js?t="+DateTime;
                                                document.getElementById("iframe"+y +b).contentWindow.document.head.appendChild(jsScript);
                                        }

										var jsScriptDragable = document.createElement("script");
										jsScriptDragable.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.3/Draggable.min.js";
										document.getElementById("iframe"+y +b).contentWindow.document.head.appendChild(jsScriptDragable);

										var jsScriptGsap = document.createElement("script");
										jsScriptGsap.src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.3/gsap.min.js";
										document.getElementById("iframe"+y +b).contentWindow.document.head.appendChild(jsScriptGsap);
                                    }
                                }, a.appendChild(c)
                            },
                            k = function() {
                                ...
                                c.open("GET", y + b +  ".html?t=" + DateTime, !0), c.onload = function() {
                                    if (c.status >= 200 && c.status < 400) {
                                        ...
                                        o && (o.parentNode.removeChild(o), A || (document.head.appendChild(o), A = !0)), W.addClass(e, "page-inner");
                                        for (var p = function() {
        ...
        H = function() {
            ...
            c.setup = function() {}, c.unload = function() {
                for (var b = 1; b <= p; b++) u[b].style.marginLeft = "", u[b].style.marginTop = "", W.removeClass(u[b], "current", "prev", "next", "before", "after");
            ...
            var d = function(a) {
                for (var b = 1; b <= p; b++) W.removeClass(u[b], "current", "prev", "next", "before", "after"), b < a ? W.addClass(u[b], "before") : b > a && W.addClass(u[b], "after");
                W.addClass(u[a], "current"), a - 1 >= 1 && W.addClass(u[a - 1], "prev"), a + 1 <= p && W.addClass(u[a + 1], "next")
            };
        ...
        I = function() {
            ...
            var e = function(a) {
                for (var b = 1; b <= p; b++) W.removeClass(u[b], "current", "prev", "next", "before", "after");
                if (W.addClass(u[a], "current"), c(a) && W.addClass(u[a + 1], "current"), 1 == a && (a = 0), a + 2 <= p && (W.addClass(u[a + 2], "next"), a + 3 <= p && W.addClass(u[a + 3], "next")), a - 1 > 0 && (W.addClass(u[a - 1], "prev"), a - 2 > 0 && W.addClass(u[a - 2], "prev")), a + 4 <= p)
                    for (b = a + 4; b <= p; b++) W.addClass(u[b], "after");
                if (a - 3 > 0)
                    for (b = a - 3; b > 0; b--) W.addClass(u[b], "before")
            };
        ...
        N = function() {
            ...
            f.setup = function() {
                ...
                this.currentSelectMode = m.SELECT_SELECT, W.removeClass(h, "panning"), h.removeEventListener("mousedown", i), document.removeEventListener("mouseup", j), h.removeEventListener("mousemove", k)
            };
            var i = function(b) {
                    return b = b || window.event, W.addClass(h, "mousedown"), a = b.clientX, c = b.clientY, g = !0, !1
                },
                j = function() {
                    W.removeClass(h, "mousedown"), g = !1
                },
                k = function(d) {
            ...
            return f.enablePanning = function() {
                this.currentSelectMode = m.SELECT_PAN, e ? M(window) : L(window), W.addClass(h, "panning"), h.addEventListener("mousedown", i), document.addEventListener("mouseup", j), h.addEventListener("mousemove", k)
    ...
    var R = function() {
            for (var a = [m.ZOOM_ACTUALSIZE, m.ZOOM_FITWIDTH, m.ZOOM_FITHEIGHT, m.ZOOM_FITPAGE, m.ZOOM_AUTO], b = ["0.25", "0.5", "0.75", "1", "1.25", "1.5", "2", "2.5", "3", "3.5", "4"], c = {}, d = 0; d < a.length; d++) {
                var e = U(a[d]);
                c[e] = a[d]
            }
            for (var f in c) {
                var g = b.indexOf(f.toString());
                g !== -1 ? b[g] = c[f] : b.push(c[f])
            }
        ...
        S = function(a) {
            for (var b = R(), c = 0; c < b.length; c++) {
                var d = b[c];
                if (U(d) > U(a)) return b[c]
            }
            return b[b.length - 1]
        },
        T = function(a) {
            for (var b = R(), c = b.length - 1; c >= 0; c--) {
                var d = b[c];
                if (U(d) < U(a)) return b[c]
            }
            return b[0]
    ...
    m.goToPage = function(a, b) {
        ...
        x ? (c.unload(), W.removeClass(b, "layout-" + c.toString()), a == m.LAYOUT_PRESENTATION ? c = H : a == m.LAYOUT_MAGAZINE ? c = I : a == m.LAYOUT_CONTINUOUS ? c = J : a == B && (c = K), c.setup(o), W.addClass(b, "layout-" + c.toString()), Q(IDRViewer.ZOOM_AUTO), c.goToPage(o), m.fire("layoutchange", {
            layout: a
        })) : k = a
